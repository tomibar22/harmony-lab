    ...
    <div className="lesson">
      ...
      <Section id="quality" num="2.3" title="האיכות: שתי משפחות של מרווחים">
        ...
        <p>
          ...
          <Term he="זכה" en="Perfect" def="איכותם הבסיסית של הפרימה, הקוורטה, הקווינטה והאוקטבה. למרווח זך אין גרסה 'גדולה' או 'קטנה' - רק מוגדלת או מוקטנת." /> -
      ...
      <Section id="semitones" num="2.4" title="לספור חצאי טונים - ולזהות מהר">
        ...
        <Widget title="אותו גודל מספרי, איכות שונה - ספרו את הקלידים שבדרך">
          <Keyboard
            fromMidi={60}
            toMidi={72}
            labels={{ 60: "דו C", 62: "רה D", 64: "מי E", 65: "פה F" }}
      ...
      <Section id="enharmonic" num="2.5" title="מוגדל, מוקטן - ואנהרמוניה של מרווחים">
        <p>
          המרווחים המוגדלים והמוקטנים אינם קוריוז תאורטי - כבר פגשנו אחד מהם: במינור ההרמוני, בין <Deg n="6" kind="active" /> ל־
          <Deg n="7" kind="active" /> המוגבהת, נפערת <b>סקונדה מוגדלת</b>. על המקלדת היא זהה לטרצה קטנה - שלושה חצאי טונים -
