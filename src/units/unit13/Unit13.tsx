...
export function Unit13() {
  ...
  return (
    <div className="lesson">
      ...
      <NextUnit current={13}>
        <b>סוף החלק השני.</b> מ־I–V–I החשוף של יחידה 7 ועד קדנצות עם ספטימות מוכנות — התחביר הטונאלי
        הבסיסי בידיכם. חִזרו, נגנו, תרגלו; החלק הבא של המסע — טכניקות של מלודיה, בס וריבוי קולות —
        עוד לפנינו.
      </NextUnit>
    </div>
  );
