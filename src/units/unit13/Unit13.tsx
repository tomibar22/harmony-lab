...
const PREP_POOL: Question[] = [
  {
    ...
    options: [
      ...
      "ספטימה שמנוגנת בהטעמה חזקה מן השאר",
      "ספטימה שמגיעה בקפיצה מודגשת מלמטה",
      "ספטימה שהפתרון שלה נכתב מראש בתווים",
    ],
  ...
  },
  {
    ...
    options: [
      "יורדת בצעד אל סי - הצליל המוביל",
      "עולה בצעד אל רה - יסוד האקורד",
      "נשארת במקומה כצליל משותף עם I",
      "קופצת מטה אל סול - יסוד הדומיננטה",
    ],
  ...
  },
  {
    ...
    options: [
      "4 - כמו IV וכמו II6",
      "2 - היסוד, כמו במצב יסודי",
      "6 - הקווינטה של האקורד",
      "1 - הספטימה, הטוניקה עצמה",
    ],
...
const CRAFT_POOL: Question[] = [
  {
    ...
    options: [
      ...
      "הכפלה כפויה של הצליל המוביל בקדנצה",
      "ספטימה שנאלצת לעלות בניגוד לדינה",
      "אין שום איום - המעבר חלק תמיד",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "הוא האקורד החזק ביותר בסולם, חזק אף מ־V",
      "אין בו שום דיסוננס, ולכן הוא בטוח לחלוטין",
      "הבס שלו הוא הטוניקה - והבית מלווה עד הסוף",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "בס שעולה בסקונדות רצופות עד הטוניקה",
      "צלילים משותפים שמחזיקים את כל השרשרת",
      "המקצב - הפעמות החזקות דוחפות קדימה",
    ],
...
const MINOR_POOL: Question[] = [
  {
    ...
    options: [
      "חצי־מוקטן: משולש מוקטן + ספטימה קטנה",
      "מז'ורי עם ספטימה גדולה, כמו IV7 במז'ור",
      "מינורי עם ספטימה קטנה, כמו II7 במז'ור",
      "מוקטן מלא: משולש וספטימה מוקטנים",
    ],
  ...
  },
  {
    ...
    options: [
      "המשולש שבבסיסו מוקטן",
      "בהיפוך ראשון קל יותר לנגן אותו במקלדת",
      "סימן ההיתק של המינור מחייב זאת",
      "אין העדפה כזו - שני המצבים שכיחים באותה מידה",
    ],
    answer: "המשולש שבבסיסו מוקטן",
  ...
  return (
    <div className="lesson">
      ...
      <NextUnit current={13}>
        ...
        <FigText text="טכניקות ‏5/3, ‏6/3 ו־6/4." />
      </NextUnit>
    </div>
  );
}
