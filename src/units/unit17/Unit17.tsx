...
const RULE_POOL: Question[] = [
  {
    ...
    options: [
      "מכפילים את הבס, והאקורד נשען על הקשר מבוקר",
      "כולם מופיעים אך ורק בקדנצות, לפני V",
      "כולם דורשים בס שמגיע בקפיצה מלמטה",
      "כולם נפתרים אל אקורד במצב יסודי בלבד",
    ],
    answer: "מכפילים את הבס, והאקורד נשען על הקשר מבוקר",
  ...
  },
  {
    ...
    options: [
      ...
      "יש בו יותר צלילים משאפשר לחלק לארבעה קולות",
      "הוא מודגש מדי - הבס שלו בולט מהמרקם",
      "הסקסטה שמעל הבס דורשת פתרון מיידי",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "הצליל המוביל - כדי לחזק את המשיכה",
      "הקוורטה שמעל הבס - צליל הטוניקה",
      "אין הכפלה - האקורד נשאר בשלושה קולות",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "שהוא בעצם אקורד טוניקה יציב לכל דבר",
      "שאין צורך לפתור אותו כשהבס קופץ",
      "שהוא שמור לסולמות מז'וריים בלבד",
    ],
...
const MINOR_POOL: Question[] = [
  {
    ...
    options: [
      "נשען על סול♯ וחוזר אל לה",
      "יורד אל סול טבעי - הסוּבּטוניקה של הקו",
      "נשאר במקומו כצליל משותף לשלושת האקורדים",
      "קופץ אוקטבה כדי לפנות מקום לבס",
    ],
    answer: "נשען על סול♯ וחוזר אל לה",
  ...
  },
  {
    ...
    options: [
      ...
      "כן - במינור מכפילים את הסקסטה במקום הבס",
      "‏6/4 נדיר במינור בגלל הסקונדה המוגדלת",
      "במינור קיים רק ה־6/4 הקדנציאלי, השאר נעלמים",
    ],
