...
const CONCEPT_POOL: Question[] = [
  ...
  },
  {
    ...
    options: [
      "היא נפתרת אל צליל שכבר קיים באקורד - ולכן אינה מחייבת אקורד חדש",
      "היא חלשה מדי לשמיעה",
      "היא דווקא מנוע חזק יותר",
      "כי היא תמיד בסופרן",
    ],
    answer: "היא נפתרת אל צליל שכבר קיים באקורד - ולכן אינה מחייבת אקורד חדש",
  ...
  },
  {
    ...
    options: [
      "קווארטה וסקסטה מעל V7 - השהיות או שכנים שלא נפתרו, כמעט תמיד בסופרן",
      "אקורדים עצמאיים בני שבעה צלילים",
      "טעויות דפוס",
      "שמות למודוסים עתיקים",
    ],
    answer: "קווארטה וסקסטה מעל V7 - השהיות או שכנים שלא נפתרו, כמעט תמיד בסופרן",
...
const SEQ_POOL: Question[] = [
  ...
  },
  {
    ...
    options: ["תמיד השהיות - צליל מוחזק מהאקורד הקודם", "תמיד צלילי מעבר", "תמיד קפיצות חופשיות", "אין נונות בסקוונצות"],
