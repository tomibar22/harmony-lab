...
const LICENSE_POOL: Question[] = [
  {
    ...
    options: [
      ...
      "הכלל מיחידה 8 נכון רק לקדנצות סיום",
      "מכפילים בו את הצליל המוביל, וזה מיישב הכול",
      "ההיתר תקף רק במינור, שם VII אינו מוקטן",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "כל רצף אקורדים שיורד ברציפות אל הדומיננטה",
      "חזרה על אותו אקורד בפריסות משתנות",
      "סולם שלם המנוגן באקורדים מקבילים",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "הסקסטה מוסיפה גוון נוגה שמאזן את העלייה",
      "ה־6/3 מאפשר להכפיל את הבס בכל חוליה",
      "אין סיבה טכנית - זו מוסכמה סגנונית בלבד",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "רק אחרי שהשלימה מעגל שלם של שבע חוליות",
      "רק על הטוניקה - כל עצירה אחרת נשמעת קטועה",
      "אסור לעצור באמצע - התבנית מחייבת עד הסוף",
    ],
...
const MINOR_POOL: Question[] = [
  {
    ...
    options: [
      ...
      "כולן עם צליל מוביל מוגבה, כמו בקדנצה",
      "רק הצורות המז'וריות של כל דרגה",
      "הצורות המלודיות - מוגבהות בעלייה בלבד",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "שום דבר מיוחד - הצורות הטבעיות שקופות",
      "שני דיסוננסים חדשים שדורשים הכנה",
      "קדנצה נמנעת מובנית בתוך התבנית",
    ],
