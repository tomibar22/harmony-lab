...
const TRANSFORM: ScoreNote[] = [
  ...
  { keys: ["d/4", "f#/4", "a/4"], midi: [62, 66, 69], mark: "V/V", sub: "דומיננטה של V", kind: "active" },
  { bar: true, keys: [], midi: [] },
  { keys: ["c/4", "e/4", "g/4"], midi: [60, 64, 67], mark: "I", sub: "הטוניקה" },
  { keys: ["c/4", "e/4", "g/4", "bb/4"], midi: [60, 64, 67, 70], mark: "V7/IV", sub: "דומיננטה של IV", kind: "active" },
];
...
const RULE_POOL: Question[] = [
  {
    ...
    options: [
      "רגע שבו דרגה מקבלת יחס של טוניקה",
      "החלפת סולם קבועה שמאושרת בקדנצה מלאה",
      "הוספת צלילים כרומטיים לאקורד הטוניקה",
      "קדנצה שמסתיימת על דרגה שאינה הטוניקה",
    ],
    answer: "רגע שבו דרגה מקבלת יחס של טוניקה",
  ...
  },
  {
    ...
    options: [
      ...
      "צליל מעבר: יורד בצעד חזרה אל מוצאו",
      "צליל חופשי: נע לכל כיוון לפי הקו",
      "צליל יסוד: מוכפל תמיד לחיזוק היעד",
    ],
  ...
  },
  {
    ...
    options: [
      "המהלך הכרומטי נשאר באותו קול",
      "מוותרים על פה♯ ומשתמשים ב־V דיאטוני",
      "מכפילים את שני הצלילים כדי לאזן",
      "מרחיקים את שני הקולות לאוקטבות שונות",
    ],
    answer: "המהלך הכרומטי נשאר באותו קול",
  ...
  },
  {
    ...
    options: [
      ...
      "‏IV אקורד חלש, והספטימה מחזקת את היעד",
      "אין הוא זקוק לה יותר משגריר אחר",
      "הספטימה מוסיפה לו את הצליל המוביל",
    ],
...
const MINOR_POOL: Question[] = [
  {
    ...
    options: [
      "רה♯, צליל מוביל מקומי שעולה אל מי ואינו קיים בסולם",
      "סול♯, שיורד חזרה אל הסוּבּטוניקה של המינור הטבעי",
      "פה♯ בלבד - אותו צליל מוביל בדיוק כמו במז'ור המקביל",
      "סי♭, הספטימה המושאלת שמפנה את השגריר אל יעדו",
    ],
    answer: "רה♯, צליל מוביל מקומי שעולה אל מי ואינו קיים בסולם",
  ...
  },
  {
    ...
    options: [
      "היעד עצמו (V) הוא אקורד מז'ורי",
      "אין דומיננטות משניות במינור - ההגבהות חוסמות אותן",
      "אין צורך בסימנים מזדמנים - הסולם כבר מכיל אותם",
      "הן נפתרות תמיד כלפי מטה, בניגוד למז'ור",
    ],
    answer: "היעד עצמו (V) הוא אקורד מז'ורי",
  ...
  return (
    <div className="lesson">
      ...
      <Section id="borrow" num="20.1" title="לשאול צליל מוביל">
        ...
        >
          <Score notes={TRANSFORM} width={520} highlightIndex={transPlayer.index} ariaLabel="אקורדים הופכים לדומיננטות משניות" />
        </Widget>
