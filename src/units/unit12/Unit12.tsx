...
const VI_POOL: Question[] = [
  {
    ...
    options: [
      "את הטרצה - שהיא הטוניקה",
      "את היסוד - הסובמדיאנטה",
      "את הקווינטה - המדיאנטה",
      "את הצליל המוביל שקדם לו",
    ],
  ...
  },
  {
    ...
    options: [
      "שניים - הטוניקה והמדיאנטה",
      "אחד בלבד - הטוניקה עצמה",
      "שלושה - הם כמעט אותו אקורד",
      "אף לא אחד - לכן ההפתעה",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "כי היא מהירה מכדי שהאוזן תספיק לנוח",
      "כי הבס עלה בצעד במקום לרדת בקווינטה",
      "היא אינה חייבת - נמנעת יכולה לסיים יצירה",
    ],
...
const MINOR_POOL: Question[] = [
  {
    ...
    options: ["מז'ורי", "מינורי", "מוקטן", "חצי־מוקטן"],
    answer: "מז'ורי",
  ...
  },
  {
    ...
    options: [
      ...
      "הבס עולה חצי טון אל V, מהצליל המוביל",
      "היא מסתיימת על הטוניקה בהיפוך ראשון",
      "היא ייחודית למז'ור, על שם המודוס הפריגי",
    ],
