...
const VOICE_POOL: Question[] = [
  {
    ...
    options: [
      ...
      "את היסוד - הסקונדה המונמכת",
      "את הקווינטה - הסובמדיאנטה",
      "את הצליל שבסופרן, יהיה אשר יהיה",
    ],
  ...
  },
  {
    ...
    options: [
      "‏♭2 קופצת אל הצליל המוביל",
      "‏♭2 עולה בחצי טון אל הסקונדה הטבעית",
      "נוצרות קווינטות מקבילות בין הקולות החיצוניים",
      "הבס נאלץ לקפוץ קווינטה מוקטנת אל היסוד",
    ],
    answer: "‏♭2 קופצת אל הצליל המוביל",
  ...
  },
  {
    ...
    options: [
      ...
      "‏♭2 יורדת אל 1 - הפתרון הטבעי שלה",
      "‏4 עולה אל 5 - הצעד שמכין את V7",
      "כל תנועה כרומטית בסופרן, באשר היא",
    ],
  ...
  },
  {
    ...
    options: [
      "במצב יסודי הבס קופץ אל V בקווינטה מוקטנת",
      "מצב הסקסטה מסתיר את הסקונדה המונמכת מהאוזן",
      "מצב יסודי אסור בתכלית - היסוד כרומטי",
      "המשקל דורש בס יציב על הפעמה החזקה",
    ],
    answer: "במצב יסודי הבס קופץ אל V בקווינטה מוקטנת",
...
const CONTEXT_POOL: Question[] = [
  {
    ...
    options: [
      ...
      "הוא הופך לדומיננטה השביעית של הסולם החדש",
      "הוא נעשה הטוניקה של סולם חצי טון מעלה",
      "הוא מוביל תמיד למינור המקביל בלבד",
    ],
  ...
  },
  {
    ...
    options: [
      "הוא דורש שני שינויים כרומטיים",
      "הוא אסור במז'ור על פי כללי התקופה",
      "במז'ור ii ממילא מוקטן, ואין מה לרכך",
      "הקדנצות במז'ור אינן זקוקות להכנה",
    ],
    answer: "הוא דורש שני שינויים כרומטיים",
  ...
  },
  {
    ...
    options: [
      "שניהם כסקונדה קטנה: מוגבהים בעלייה ומונמכים בירידה",
      "תמיד עם במולים בלבד - הכתיב הרך מכל האפשרויות",
      "כאוניסון מוגדל, על אותו קו או רווח בחמשה",
      "לפי סימן ההיתק של הסולם הכרומטי הקרוב ביותר",
    ],
    answer: "שניהם כסקונדה קטנה: מוגבהים בעלייה ומונמכים בירידה",
  ...
  },
  {
    ...
    options: [
      ...
      "לא - אקורד כרומטי אינו יכול לקבל דומיננטה",
      "רק במז'ור, שבו הוא ממילא אורח נדיר",
      "רק בסופי יצירות, כתחליף לקדנצה פלגלית",
    ],
