    ...
    <div className="lesson">
      ...
      <Section id="scale" num="1.3" title="הסולם ודרגותיו">
        ...
        <p>
          ...
          , ובזכות <b>שקילות האוקטבות</b> אנחנו מתייחסים אליהם כאל בני אותה משפחה - <Deg n="8" kind="stable" /> היא שוב <Deg n="1" kind="stable" />.
        </p>
      </Section>
      ...
      <Section id="steps" num="1.4" title="טונים שלמים, חצאי טונים - והמבנה המז'ורי">
        <p>
          ...
          חצאי הטונים נופלים בדיוק בין <Deg n="3" kind="stable" />–<Deg n="4" kind="active" /> ובין <Deg n="7" kind="active" />–<Deg n="8" kind="stable" />. כל יצירה
        ...
        <p>
          ...
          לכולם אותם מרכיבים, וההבדל כולו במיקום חצאי הטונים. על ההבדל הזה בנויה המוזיקה המערבית מיוון העתיקה
          ועד המאה התשע־עשרה.
        </p>
      </Section>
      ...
      <Section id="active" num="1.5" title="יציב, פעיל, ומשיכת חצי הטון">
        ...
        <p>
          ...
          <Term he="צליל עובר" en="Passing tone (P)" def="צליל פעיל המגשר בצעדים בין שני צלילים יציבים שונים, למשל 1–2–3." /> שמוליך
        ...
        <Widget title="מעבר לעומת שכן - מעל אותו משולש טוניקה">
          <div className="w-foot" style={{ marginTop: 0, direction: "rtl" }}>
            <PlayButton label={<>מעבר: <span dir="ltr">1–2–3</span></>} ghost events={overTriad([60, 62, 64])} bpm={92} player={pnPlayer} />
            <PlayButton label={<>שכן עליון: <span dir="ltr">3–4–3</span></>} ghost events={overTriad([64, 65, 64])} bpm={92} player={pnPlayer} />
            <PlayButton label={<>שכן תחתון: <span dir="ltr">3–2–3</span></>} ghost events={overTriad([64, 62, 64])} bpm={92} player={pnPlayer} />
          </div>
        </Widget>
      </Section>
      ...
      <Section id="tonality" num="1.11" title="טונאליות - ולמה מינור 'עצוב'?">
        <p>
          ...
          כנוגים. שפטו בעצמכם - אותו משפט בדיוק, פעם עם <Deg n="3" kind="stable" /> גבוהה ופעם עם נמוכה:
        </p>
