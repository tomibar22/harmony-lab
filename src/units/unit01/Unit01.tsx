...
export function Unit01() {
  ...
  return (
    <div className="lesson">
      ...
      <Section id="key" num="1.1" title="מהו מפתח?">
        <p>
          ...
          מוזיקה נמצאת "במפתח" כאשר צליל אחד משמש מרכז כובד, וכל השאר מקבלים את תפקידם מתוך היחס אליו.
        </p>
        <Widget
      ...
      <Section id="tonic" num="1.2" title="הטוניקה: נקודת מוצא ויעד">
        <p>
          לצליל המרכזי קוראים <Term he="טוניקה" en="Tonic" def="הצליל המרכזי של המפתח: נקודת המוצא של התנועה הטונאלית והיעד שאליו היא שואפת." />.
      ...
      <Section id="scale" num="1.3" title="הסולם ודרגותיו">
        <p>
          כשמסדרים את צלילי המפתח בסדר עולה מטוניקה לטוניקה מתקבל{" "}
          <Term he="סולם" en="Scale" def="צלילי המפתח מסודרים בזה אחר זה, מהטוניקה אל הטוניקה שמעליה. מלטינית scala — סולם, מדרגות." />
          . לכל שלב יש מספר (עם גג קטן מעליו) ושם מסורתי:
        </p>
        <Widget
      ...
      <Section id="steps" num="1.4" title="טונים שלמים, חצאי טונים — והמבנה המז'ורי">
        <p>
          ...
          שצליליה יוצרים את התבנית הזאת, מהטוניקה שלה — נמצאת במפתח מז'ורי.
        </p>
        <Widget title="איפה אין קליד שחור? שם מסתתר חצי הטון">
          <Keyboard
            fromMidi={60}
            toMidi={72}
            labels={{ 60: "דו", 62: "רה", 64: "מי", 65: "פה", 67: "סול", 69: "לה", 71: "סי", 72: "דו" }}
            brackets={[
      ...
      <Section id="signatures" num="1.6" title="טרנספוזיציה, סימני היתק ומעגל הקווינטות">
        <p>
          אפשר לבנות את תבנית המז'ור מכל צליל — זו <Term he="טרנספוזיציה" en="Transposition" def="העברת קטע מוזיקלי למפתח אחר תוך שמירה על תבנית המרווחים." />.
          אבל ברגע שעוזבים את דו, חייבים דיאזים או במולים כדי לשמור את חצאי הטונים במקומם. הסימנים הקבועים
          נאספים ל<Term he="סימן היתק" en="Key signature" def="הדיאזים או הבמולים הקבועים של המפתח, הרשומים בתחילת כל שורה." /> בתחילת
          השורה. חמישה־עשר מפתחות מז'וריים מסתדרים על מעגל: קווינטה למעלה — עוד דיאז; קווינטה למטה — עוד במול.
        </p>
        <Widget title="מעגל הקווינטות — בחרו מפתח, ראו את סימן ההיתק, נגנו את הסולם">
          <CircleOfFifths />
        </Widget>
      ...
      <Section id="chromatic" num="1.7" title="כרומטיקה ואנהרמוניה">
        <p>
          לא כל דיאז מודיע על מפתח חדש. לרוב הוא בסך הכול <Term he="כרומטיקה" en="Chromaticism" def="שימוש בצלילים שאינם שייכים למפתח, כקישוט או הדגשה של התשתית הדיאטונית. מיוונית chroma — צבע." /> —
      ...
      <Section id="minor" num="1.8" title="מינור: סולם אחד, שלוש צורות">
        <p>
          מה מבדיל מפתח מינורי ממז'ורי? בראש ובראשונה הטרצה שמעל הטוניקה: קטנה במינור, גדולה במז'ור —
      ...
      <Section id="relations" num="1.9" title="קרובי משפחה: מקביל ומקביל־טוניקה">
        <p>
          ...
          (לה מינור ↔ דו מז'ור) אבל לא את הטוניקה — אלה שני מפתחות שונים! ולעומתו <b>מינור פרלל</b> חולק את{" "}
          ...
          <Term he="מיקסטורה" en="Mixture" def="שאילת צלילים בין מפתח מז'ורי למינור הפרלל שלו — נושא שיורחב ביחידה 24." /> שנפגוש
          שוב בהמשך הספר.
        </p>
      </Section>
      ...
      <Section id="modes" num="1.10" title="שבעת המודוסים של הסדר הדיאטוני">
        ...
        <p>
          ...
          (אאולי, על שלוש צורותיו). השאר מציצים מדי פעם כצבע, והם מפתח הכרחי למוזיקה מוקדמת ולג'אז.
        </p>
      </Section>
      ...
      <Section id="review" num="1.12" title="נקודות לחזרה">
        <div className="review-grid">
          <div className="review-chip"><b>מפתח</b>מערכת יחסים סביב צליל מרכזי — הטוניקה.</div>
          <div className="review-chip"><b>סולם</b>צלילי המפתח מטוניקה לטוניקה; לכל דרגה מספר ושם.</div>
