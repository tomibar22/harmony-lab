...
const DOUBLING_POOL: Question[] = [
  {
    ...
    options: ["את הבס (הצליל המוביל)", "את היסוד", "את הקווינטה", "מותר להכפיל הכול"],
  ...
  },
  {
    ...
    options: ["את הבס (הסופרטוניקה)", "את הצליל המוביל", "את הקווינטה (דרגה 4)", "שום דבר"],
  ...
  },
  {
    ...
    options: ["הובלת הקולות — כל צליל כשר חוץ מהצליל המוביל", "תמיד מכפילים את הבס", "תמיד מכפילים את היסוד", "תמיד מכפילים את הקווינטה"],
  ...
  },
  {
    ...
    options: ["אין מחיר — האקורד שלם והפתרון חלק", "הטוניקה מאבדת את הטרצה", "נוצרות קווינטות מקבילות", "הסופרן חייב לקפוץ"],
...
const ROLE_POOL: Question[] = [
  ...
  },
  {
    ...
    options: ["הוא נותן לבס לזוז בלי לעזוב את הטוניקה", "הוא מגביר את המתח ההרמוני", "הוא מחליף את הדומיננטה", "הוא מוסיף דיסוננס"],
  ...
  },
  {
    ...
    options: ["הפתרון מוקל — דרגה 4 רשאית לעלות אל 5", "הוא חייב להיפתר כרגיל", "הוא נעלם מהאקורד", "הוא הופך לקונסוננס"],
    ...
    <div className="lesson">
      ...
      <Section id="vii6" num="8.4" title="‏VII6 — אקורד המעבר">
        <p>
          ...
          <Term he="אקורד מעבר" en="Passing chord" def="אקורד שממלא צעד בין שני אקורדים יציבים, כשם שצליל מעבר ממלא צעד בין שני צלילים." /> המושלם
        ...
        <Callout label="דקות חשובה">
          ...
          הדין מוקל: <Deg n="4" kind="active" /> רשאית להמשיך מעלה אל <Deg n="5" /> עם כיוון הקו. תנועת
      ...
      <Section id="minor" num="8.6" title="ובמינור? אותו דקדוק, עם 7 מוגבהת">
        <p>
          ...
          מגביהים את <Deg n="7" /> גם בתוך VII6. בלה מינור, סול♯ הוא חלק מהאקורד, והבס — סי, הסופרטוניקה
