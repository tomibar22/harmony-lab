...
const CONCEPT_POOL: Question[] = [
  {
    ...
    options: [
      ...
      "מודולציה קצרה אל המינור המקביל וחזרה",
      "טוניקיזציה של הדרגה השישית המונמכת",
      "מעבר הדרגתי בין שני סולמות שכנים",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "‏♯4 (פה♯ בדו מז'ור) - עולה אל הדומיננטה",
      "‏♭7 (סי♭ בדו מז'ור) - עומד במקומו",
      "‏♭2 (רה♭ בדו מז'ור) - קופץ אל הטוניקה",
    ],
  ...
  },
  {
    ...
    options: [
      "הם מחליפים מודוס, לא מרכז",
      "הם קצרים מכדי שהאוזן תספיק להגיב",
      "הם דווקא מערערים - וזו כל מטרתם",
      "הם נטולי סימנים מזדמנים, ולכן שקופים",
    ],
    answer: "הם מחליפים מודוס, לא מרכז",
  ...
  },
  {
    ...
    options: [
      "אין בה סכנה: מכפילים את הטרצה, והקולות נפתרים כרגיל",
      "היא גוררת קווינטות מקבילות שאין מהן שום מנוס",
      "הצליל המוביל נאלץ לרדת בה, בניגוד גמור לדינו",
      "הספטימה של V7 נאלצת לעלות בה אל לה♭, לא לרדת",
    ],
    answer: "אין בה סכנה: מכפילים את הטרצה, והקולות נפתרים כרגיל",
...
const PICARDY_POOL: Question[] = [
  {
    ...
    options: [
      "סיום יצירה מינורית על אקורד טוניקה מז'ורי",
      "טרצה כפולה בין סופרן לאלט בקדנצה",
      "פתיחת יצירה מז'ורית באקורד מינורי",
      "הטרצה הקטנה שבין 6 ל־1 במינור",
    ],
    answer: "סיום יצירה מינורית על אקורד טוניקה מז'ורי",
  ...
  },
  {
    ...
    options: [
      "שההשאלה עובדת לשני הכיוונים",
      "שההשאלה מותרת רק ברגע הסיום עצמו",
      "שמדובר בהרגל עתיק שאין לו הסבר",
      "שהמינור נחות מן המז'ור בעיני התקופה",
    ],
    answer: "שההשאלה עובדת לשני הכיוונים",
