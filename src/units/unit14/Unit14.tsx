...
const III_POOL: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "לסיים קדנצות אותנטיות במקום I",
      "להכין את הדומיננטה, כמו IV ו־II",
      "להחליף את IV בכל הקשר מינורי",
    ],
  ...
  },
  {
    ...
    options: [
      "האקורד אינו דומיננטי",
      "הצליל המוביל יורד תמיד כשהוא בקול פנימי",
      "זו חירות אמנותית - שגיאה שהזמן הכשיר",
      "הירידה מותרת רק במינור, שם אין צליל מוביל",
    ],
    answer: "האקורד אינו דומיננטי",
  ...
  },
  {
    ...
    options: [
      ...
      "הוא צורם - הקווינטה שלו דיסוננטית",
      "צליליו גבוהים מכדי להישמע בבירור",
      "הוא שמור בלעדית לסולמות המינוריים",
    ],
...
const MINOR_POOL: Question[] = [
  {
    ...
    options: [
      "מז'ורי - אקורד הסולם המקביל, שער שדרכו המינור נוטה אל המז'ור",
      "מינורי - צבע אגבי חסר תפקיד מיוחד בתחביר המינור",
      "מוקטן - ולכן חי רק בהיפוך ראשון, כמו VII ו־II",
      "מוגדל - בגלל הצליל המוביל המוגבה של המינור ההרמוני",
    ],
    answer: "מז'ורי - אקורד הסולם המקביל, שער שדרכו המינור נוטה אל המז'ור",
  ...
  },
  {
    ...
    options: [
      ...
      "זו טעות נפוצה - בירידה יש להגביה את שניהם",
      "טבעיים קלים יותר לשירה, וזו כל הסיבה",
      "אין הבדל של ממש - שתי הצורות שקולות בירידה",
    ],
  ...
  return (
    <div className="lesson">
      ...
      <Section id="iii" num="14.2" title="‏III - המשולש האחרון, והצליל המוביל היורד">
        <p>
          משולש המדיאנטה <b>III</b> בנוי על <Deg n="3" kind="stable" /> ומכיל את <Deg n="5" kind="stable" /> ואת{" "}
