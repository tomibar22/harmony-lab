    ...
    <div className="lesson">
      ...
      <Section id="axis" num="7.1" title="שני אקורדים שמגדירים סולם">
        <p>
          ...
          <Deg n="5" kind="stable" /> — ומשולש הדומיננטה אוסף את הפעילוֹת: <Deg n="5" />,{" "}
      ...
      <Section id="connect" num="7.2" title="לחבר I–V–I בארבעה קולות">
        <p>
          החיבור החלק ביותר נשען על שני עקרונות מיחידה 6: <b>הצליל המשותף</b> — <Deg n="5" /> שייך לשני
      ...
      <Section id="minor" num="7.6" title="ובמינור? מגביהים את 7">
        <p>
          ...
          <em className="hl">תמיד</em> מגביהים את <Deg n="7" /> בתוך הדומיננטה: בלה מינור, סול הופך
