...
const PHRASE_FORMS = [
  {
    he: "השלד",
    notes: [
      { keys: ["g/4"], midi: [67], duration: "h", kind: "stable", degree: "5" },
      { keys: ["e/4"], midi: [64], duration: "h", kind: "stable", degree: "3" },
      { bar: true, keys: [], midi: [] },
      { keys: ["d/4"], midi: [62], duration: "w", kind: "active", degree: "2" },
      { bar: true, keys: [], midi: [] },
      { keys: ["c/4"], midi: [60], duration: "w", kind: "stable", degree: "1" },
    ] as ScoreNote[],
  ...
  },
  {
    he: "עם קישוט",
    notes: [
      { keys: ["g/4"], midi: [67], duration: "q", kind: "stable", degree: "5" },
      { keys: ["f/4"], midi: [65], duration: "q", mark: "P", kind: "active" },
      { keys: ["e/4"], midi: [64], duration: "h", kind: "stable", degree: "3" },
      { bar: true, keys: [], midi: [] },
      { keys: ["d/4"], midi: [62], duration: "q", kind: "active", degree: "2" },
      { keys: ["e/4"], midi: [64], duration: "q", mark: "N", kind: "active" },
      { keys: ["d/4"], midi: [62], duration: "h" },
      { bar: true, keys: [], midi: [] },
      { keys: ["c/4"], midi: [60], duration: "w", kind: "stable", degree: "1" },
    ] as ScoreNote[],
    note: "אותו שלד בדיוק - ובין צלילי האקורד נשזרו צליל עובר (פה) ושכן עליון (מי מעל V). המלודיה נושמת.",
  },
] as const;
...
const TYPE_POOL = [
  { desc: "נכנס בצעד, ממשיך בצעד באותו כיוון - מגשר בין שני צלילי אקורד", ans: "צליל עובר", why: "הוותיק מכולם, ירושה ישירה מהמין השני בקונטרפונקט." },
...
const RULE_POOL: Question[] = [
  {
    ...
    options: [
      "הוא זר להרמוניה הרגעית",
      "הוא תמיד קצר מצלילי האקורד שסביבו",
      "הוא תמיד נוחת על הפעמה החזקה בתיבה",
      "אין הבדל - כל צליל שנשמע שייך לאקורד",
    ],
    answer: "הוא זר להרמוניה הרגעית",
    explain: <>האנליזה מתחילה כאן: קודם מזהים מה שייך לאקורד, ואז כל השאר חייב הסבר מלודי - מעבר, שכן, אפוג'טורה...</>,
  },
  {
    prompt: <>מה ההבדל המהותי בין צליל עובר לאפוג'טורה?</>,
    options: [
      "המעבר נבלע בתנועה בפעמה קלה",
      "המעבר תמיד עולה, והאפוג'טורה תמיד יורדת",
      "האפוג'טורה קונסוננטית והמעבר דיסוננטי",
      "אין הבדל - שני שמות לאותה תופעה",
    ],
    answer: "המעבר נבלע בתנועה בפעמה קלה",
  ...
  },
  {
    ...
    options: [
      "היא חושפת את ההרמוניה האמיתית מתחת לשטף הצלילים",
      "היא מייפה את התווים ומקילה על הקריאה",
      "היא קובעת את הטמפו הנכון לביצוע",
      "היא רלוונטית רק למוזיקה בת ארבעה קולות",
    ],
    answer: "היא חושפת את ההרמוניה האמיתית מתחת לשטף הצלילים",
    explain: <>מי שמנסה לתייג כל צליל כאקורד טובע. מי שמזהה את השלד - קורא דף של באך כמו משפט אחד פשוט.</>,
  },
  {
    prompt: <>מאיפה מוכרים לנו צליל העובר והשכן?</>,
    options: [
      "מהמין השני והשלישי בקונטרפונקט - יחידה 5",
      "מהקדנצות של יחידה 7 - שם נולדו",
      "ממעגל הקווינטות וסימני ההיתק",
      "זו פגישה ראשונה - מושגים חדשים לגמרי",
    ],
...
const MINOR_POOL: Question[] = [
  {
    ...
    options: [
      "סול♯ - הצליל המוביל, שנמשך חזרה מעלה",
      "סול טבעי - הסוּבּטוניקה הרכה",
      "פה - הסובמדיאנטה שמתחת",
      "סי - השכן העליון, בהיפוך",
    ],
  ...
  },
  {
    ...
    options: [
      "טבעיים - הירידה הולכת בצד הטבעי של המינור",
      "מוגבהים - כמו במינור המלודי בעלייה",
      "סול מוגבה ופה טבעי - צורת הביניים",
      "מושמטים - קופצים היישר אל מי",
    ],
  ...
  return (
    <div className="lesson">
      ...
      <Section id="skeleton" num="18.1" title="שלד וקישוט - אותה מוזיקה, פעמיים">
        <p>
          קחו את המשפט הפשוט בעולם - <Deg n="5" kind="stable" />–<Deg n="3" kind="stable" /> מעל I,{" "}
      ...
      <Section id="calm" num="18.2" title="המשפחה השקטה: מעבר, שכן, דילוג">
        <p>
          ...
          <b>צליל עובר</b> נכנס בצעד וממשיך בצעד באותו כיוון; <b>שכן</b> יוצא בצעד וחוזר מיד;{" "}
