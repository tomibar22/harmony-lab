...
export function Unit04() {
  ...
  return (
    <div className="lesson">
      ...
      <Section id="triad" num="4.1" title="מהו אקורד? המשולש וחלקיו">
        <p>
      ...
      <Section id="degrees" num="4.3" title="משולש על כל דרגה - והספרות הרומיות">
        ...
        <Callout label="והמינור ההרמוני?" insight>
          הטבלה של המינור הטבעי מסתירה את העיקר: ברגע שמגביהים את <Deg n="7" kind="active" /> לצליל מוביל, הדרגה
      ...
      <Section id="v7" num="4.6" title="ספטאקורד הדומיננטה והיפוכיו">
        <p>
          מדוע דווקא הספטאקורד הדומיננטי חשוב כל כך? בנו אותו על <Deg n="5" kind="stable" /> במז'ור ותראו: הוא מכיל את
          הצליל המוביל <em>וגם</em> את <Deg n="4" kind="active" /> - כלומר את הטריטון מיחידה 2 - ועוד ספטימה מול היסוד.
