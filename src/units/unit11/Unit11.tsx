...
const IDENTITY_POOL: Question[] = [
  {
    ...
    options: [
      ...
      "כטוניקה לכל דבר, שהרי אלה צליליה",
      "כאקורד הכנה עצמאי, מקביל ל־II6",
      "כאקורד מעבר בין הטוניקה להיפוכה",
    ],
  ...
  },
  {
    ...
    options: [
      "כי הקוורטה מעל הבס דיסוננטית",
      "כי אין בו כלל את צליל הטוניקה עצמו",
      "כי הוא מופיע רק בסולמות מינוריים",
      "כי הבס שלו הוא הטוניקה, לא הדומיננטה",
    ],
    answer: "כי הקוורטה מעל הבס דיסוננטית",
...
const RESOLVE_POOL: Question[] = [
  {
    ...
    options: [
      "יורדת בצעד אל רה - הקווינטה של V",
      "עולה בצעד אל פה - הספטימה של V7",
      "נשארת במקומה כצליל משותף",
      "קופצת מטה אל סול - יסוד האקורד",
    ],
  ...
  },
  {
    ...
    options: [
      "יורדת בצעד אל סי - הטרצה של V",
      "עולה בצעד אל רה - הקווינטה של V",
      "נשארת במקומה עד הטוניקה הבאה",
      "קופצת מעלה אל מי - סקסטה חדשה",
    ],
  ...
  },
  {
    ...
    options: [
      "יורדת אל הספטימה: 8 ← 7",
      "עולה אל הנונה: 8 ← 9",
      "נשארת במקומה בהכרח, כעוגן",
      "מושמטת יחד עם הקווינטה",
    ],
  ...
  },
  {
    ...
    options: [
      "סול דיאז - הצליל המוביל המוגבה",
      "סול טבעי - הסובטוניקה של הסולם",
      "פה - הסובמדיאנטה שמעל הבס",
      "סי - הסופרטוניקה, בקפיצה",
    ],
...
const CRAFT_POOL: Question[] = [
  {
    ...
    options: [
      ...
      "בכל מקום - המשקל אינו משנה",
      "רק בפעמה האחרונה של התיבה",
    ],
  ...
  },
  {
    ...
    options: [
      "‏I, ‏I6, ‏IV או II6 - אקורדי טוניקה והכנה",
      "‏V או V7 - מתוך הדומיננטה עצמה",
      "‏VII6 - אקורד המעבר המוקטן",
      "רק מ־I במצב יסודי, ותו לא",
    ],
