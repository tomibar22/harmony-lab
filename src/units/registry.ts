...
export const UNITS: UnitMeta[] = [
  ...
  { id: "08", num: 8, part: 2, title: "סקסט־אקורדים: I6, V6 ו־VII6", blurb: "היפוכים ראשונים בשירות קו הבס.", ready: false },
  { id: "09", num: 9, part: 2, title: "היפוכי V7", blurb: "6/5, 4/3 ו־4/2 — הדומיננטה בכל מצביה.", ready: false },
  { id: "10", num: 10, part: 2, title: "בדרך אל V: ‏IV, ‏II ו־II6", blurb: "אקורדי ההכנה של הדומיננטה.", ready: false },
