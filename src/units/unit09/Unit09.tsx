...
const RESOLVE_POOL: Question[] = [
  {
    ...
    options: [
      "אל I6, כי הבס (הספטימה) חייב לרדת אל 3",
      "אל I במצב יסודי, כמו כל דומיננטה",
      "אל V6, בהחלפת מצב בתוך הדומיננטה",
      "אל VI, בקדנצה הנמנעת המתבקשת",
    ],
  ...
  },
  {
    ...
    options: [
      "שני האקורדים נשארים שלמים - אין צורך להשמיט קווינטה",
      "הם חזקים יותר בקדנצות ולכן מסיימים משפטים",
      "אין בהם טריטון, ולכן אין מה לפתור",
      "הספטימה שלהם פטורה מחובת הירידה",
    ],
  ...
  },
  {
    ...
    options: [
      "ב־V43 עובר, כשהיא נעה בטרצות מקבילות עם הבס",
      "תמיד - בהיפוכים הספטימה חופשייה לגמרי",
      "אף פעם - דין הדיסוננס אינו יודע רחמים",
      "רק בקדנצה אותנטית שלמה, ובסופרן בלבד",
    ],
  ...
  },
  {
    ...
    options: [
      "אקורד מעבר בין I ל־I6, עם 2 בבס",
      "סיום קדנצות על הדומיננטה",
      "שכן עליון קבוע של הדומיננטה",
      "תחליף מלא לסובדומיננטה",
    ],
