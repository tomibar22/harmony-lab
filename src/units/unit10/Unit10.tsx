...
const CRAFT_POOL: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "יש להם שלושה צלילים משותפים שמדביקים אותם",
      "שניהם משולשים מז'וריים באותה איכות",
      "הבס נשאר במקומו ומחזיק את החיבור",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "מנגנים אותה מודגשת יותר משאר הקולות",
      "היא מגיעה בקפיצה מודגשת מלמטה",
      "היא מושמטת ומושלמת באוזן בלבד",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "כן, זה המהלך הנפוץ ביותר בקדנצות",
      "רק במינור, שבו המשיכה חלשה יותר",
      "רק כשהסופרן יורד בסולם שלם",
    ],
...
const MINOR_POOL: Question[] = [
  {
    ...
    options: [
      "‏II במינור הוא משולש מוקטן",
      "‏II במינור כולל את הצליל המוביל, שאסור בבס",
      "הבס של II במינור גבוה מכדי להישמע יציב",
      "אין הבדל של ממש - שני המצבים שווים בשימוש",
    ],
    answer: "‏II במינור הוא משולש מוקטן",
    ...
    <div className="lesson">
      ...
      <Section id="between" num="10.1" title="הצלע השלישית של המשפט">
        <p>
          ...
          על שתי הדרגות שמקיפות את הדומיננטה: <Deg n="4" kind="active" /> ו־<Deg n="6" kind="active" />, ואיתן{" "}
