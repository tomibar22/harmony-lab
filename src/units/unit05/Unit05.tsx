...
const SPECIES_TABS = [
  {
    ...
    seq: SPECIES2_SEQ,
    bpm: 76,
    note: "שני חצאים על כל תו של הקאנטוס. הפעמה החזקה חייבת קונסוננס; בחלשה מותר צליל עובר דיסוננטי (P) - פה חולף בין מי לסול מעל הדו שבבס.",
  },
  {
    he: "מין שלישי (4:1)",
    ...
    <div className="lesson">
      ...
      <Section id="what" num="5.1" title="נקודה כנגד נקודה">
        <p>
          ...
          מוסיפה קושי אחד בכל שלב: קודם רק קונסוננסים, אחר כך צלילים עוברים, ולבסוף הדיסוננס המושהה.
        </p>
      ...
      <Section id="species" num="5.5" title="המינים הבאים: תנועה, ריצה והשהיה">
        ...
        <Callout label="רעיון מרכזי" insight>
          ...
          (2–3), מושהה ונפתר (4). כשנפגוש צלילים עוברים, שכנים והשהיות בתוך אקורדים - אלה בדיוק אותם
          מנגנונים.
        </Callout>
      </Section>
      ...
      <Section id="review" num="5.6" title="נקודות לחזרה">
        <div className="review-grid">
          ...
          <div className="review-chip"><b>מין שני ושלישי</b>דיסוננס רק כצליל עובר בפעמה חלשה.</div>
