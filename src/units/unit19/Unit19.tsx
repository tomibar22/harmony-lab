...
const ANATOMY_POOL: Question[] = [
  {
    ...
    options: [
      ...
      "השהיה (פעמה חזקה) ← הכנה (פעמה קלה) ← פתרון (צעד מעלה)",
      "הכנה (דיסוננס) ← פתרון (קונסוננס) ← השהיה (חוזרת)",
      "כניסה חופשית ← החזקה ← יציאה חופשית",
    ],
  ...
  },
  {
    ...
    options: [
      "צעד אחד מטה - כמעט תמיד",
      "צעד אחד מעלה - כמעט תמיד",
      "קפיצה חופשית לצליל האקורד הקרוב",
      "אינה נפתרת - היא נמוגה עם האקורד",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "צליל שכן ממנו מגיעים בצעד מלמעלה",
      "דיסוננס קודם שמכשיר את הבא אחריו",
      "הפסקה קצרה שמפרידה בין האקורדים",
    ],
...
const TIME_POOL: Question[] = [
  {
    ...
    options: [
      ...
      "אין הבדל - שני שמות לאותו עיכוב",
      "האנטיציפציה נוחתת תמיד על פעמה חזקה יותר",
      "ההשהיה עולה בצעד והאנטיציפציה יורדת בו",
    ],
  ...
  },
  {
    ...
    options: [
      "צליל בס מוחזק - לרוב טוניקה או דומיננטה - שההרמוניות נודדות מעליו",
      "שימוש בדוושת הפסנתר כדי להאריך את צליל האקורד",
      "אקורד יחיד שחוזר שוב ושוב בקצב קבוע לאורך הקטע",
      "קדנצה שהפתרון שלה נדחה שוב ושוב, בלי להגיע ליעד",
    ],
    answer: "צליל בס מוחזק - לרוב טוניקה או דומיננטה - שההרמוניות נודדות מעליו",
  ...
  },
  {
    ...
    options: [
      "הפדל הוא רובד נפרד: הדיסוננס נמדד מול ההרמוניה שמעליו בלבד",
      "‏V מותר תמיד מול כל בס באשר הוא - הוא הדומיננטה",
      "זה אכן אסור - מלחינים פשוט מפרים כאן את הכלל",
      "הבס המוחזק חלש מכדי שהחיכוך שמעליו יישמע כלל",
    ],
    answer: "הפדל הוא רובד נפרד: הדיסוננס נמדד מול ההרמוניה שמעליו בלבד",
